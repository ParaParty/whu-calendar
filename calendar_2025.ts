...
for (let i = 0; i < 18; i++) {
  let weekStart = new Date(2026, 3, 1).addWeek(i);
  let weekEnd = new Date(2026, 3, 1).addWeek(i + 1);
...
for (let i = 0; i < 2; i++) {
  let weekStart = new Date(2026, 7, 5).addWeek(i);
  let weekEnd = new Date(2026, 7, 5).addWeek(i + 1);
